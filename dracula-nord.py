...
file = sys.argv[1] if len(sys.argv) == 2 else input("Enter path of the file: ")  # noqa: PLR2004
file_path = Path(file).expanduser().resolve()
print("The file provided is ", file_path)
if not file_path.exists():
    print("\033[0;31mThe file doesn't exist!\033[0m")
    sys.exit()

data = file_path.read_text(encoding="utf-8", newline="\n")

print("\nCreating Backup...")
backup_path = Path("/tmp", file_path.name + ".bak")  # noqa: S108
